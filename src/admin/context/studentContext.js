...
const token =
  "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyIjp7ImVtYWlsIjoiYWRtaW5AZ21haWwuY29tIiwicm9sZSI6ImFkbWluIn0sImlhdCI6MTYxNzg4Mzg3MSwiZXhwIjoxNjE3ODkxMDcxfQ.Q60wP95Ox8j-IuNeXuuBlJ8WpHiDVqgL2xxDMkkD7z4";
...
const StudentProvider = ({ children }) => {
  ...
  const createStudent = (data, image) => {
    const formData = data;
    const submitData = {
