...
const ResultProvider = ({children})=>{
    ...
    const [details, setDetails] = React.useState({class : "", subject: "", term : "", session : ""})
   ...
   const handleChange3 = (e, id)=>{
    ...
    return <ResultContext.Provider value ={{ message, handleClick2, handleClick3, setUpdate, update, details,setDetails, handleChange1, handleChange2, handleChange3, handleClick }}>{children}</ResultContext.Provider>
}
