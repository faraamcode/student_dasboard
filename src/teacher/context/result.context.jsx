...
const ResultProvider = ({children})=>{
   ...
   const handleChange3 = (e, id)=>{
    ...
    return <ResultContext.Provider value ={{ message, handleClick2, setUpdate, update, details,setDetails, handleChange1, handleChange2, handleChange3, handleClick }}>{children}</ResultContext.Provider>
}
